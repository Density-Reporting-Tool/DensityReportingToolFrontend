            ...
            <TableHead>
              <TableRow sx={{ backgroundColor: 'grey.50' }}>
                <TableCell padding="checkbox">
                  <Checkbox
                    checked={contacts.length > 0 && contacts.every(contact => contact.isSelected)}
                    indeterminate={selectedCount > 0 && selectedCount < contacts.length}
              ...
              {filteredContacts.map((contact) => (
                <TableRow 
                  ...
                  sx={{ 
                    ...
                    backgroundColor: contact.isSelected ? 'primary.50' : 'inherit'
                  }}
                >
                  <TableCell padding="checkbox">
                    <Checkbox
