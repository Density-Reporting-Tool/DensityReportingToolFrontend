...
const AddDensityTest: React.FC = () => {
  ...
  // Debug logging
  console.log(
    "AddDensityTest - URL params - JobId:",
    jobId,
    "ReportId:",
    reportId,
  );
  ...
  const handleInputChange = (
    field: keyof DensityTestFormData,
    value: string | number,
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleSave = async () => {
    ...
    if (
      formData.compactionSpecification < 0 ||
      formData.compactionSpecification > 110
    ) {
    ...
    try {
      ...
      console.log(
        "Creating density test for report:",
        reportId,
        densityTestData,
      );

      // Create density test via API
      const response = await apiService.createDensityTest(
        parseInt(reportId),
        densityTestData,
      );
    ...
    <>
      ...
      <Container maxWidth="xl" sx={{ my: 3, mb: 12 }}>
        ...
        <Stack gap={2}>
              ...
              >
                {proctors.map((proctor) => (
                  <MenuItem key={proctor.id} value={proctor.id.toString()}>
                    {proctor.proctorID} - {proctor.proctorType} (
          ...
          {selectedProctor && (
            <Paper
              sx={{ padding: 2, borderRadius: 2, backgroundColor: "grey.50" }}
            >
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  <Typography variant="body2">
                    ...
                    {selectedProctor.maxDensity || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2">
                    <strong>Optimum Moisture:</strong>{" "}
                    {selectedProctor.optimumMoistureContent || "N/A"}%
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2">
                    <strong>Corrected Density:</strong>{" "}
                    {selectedProctor.correctedDensity || "N/A"}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2">
                    <strong>Specific Gravity:</strong>{" "}
                    {selectedProctor.specificGravity || "N/A"}
                  </Typography>
                </Grid>
              </Grid>
            </Paper>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleInputChange("testArea", e.target.value)
                  }
              ...
              <Grid item xs={12} md={4}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleInputChange("elevationReference", e.target.value)
                    }
                  ...
                  >
                    ...
                    <MenuItem value="AboveFinalGrade">
                      Above Final Grade
                    </MenuItem>
                    <MenuItem value="BelowFinalGrade">
                      Below Final Grade
                    </MenuItem>
              ...
              <Grid item xs={12} md={4}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleInputChange("elevationUnit", e.target.value)
                    }
                    label="Unit"
                  >
              ...
              <Grid item xs={12} md={4}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleInputChange("probeDepthUnit", e.target.value)
                    }
