      ...
      <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}>
        ...
        <Paper sx={{ p: 3, borderRadius: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Opens the distribution list manager as a modal dialog. Perfect for
            quick contact management without leaving the current page.
          </Typography>
          <Button
            variant="contained"
        ...
        <Paper sx={{ p: 3, borderRadius: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Renders the distribution list manager as a full page. Ideal for
            dedicated contact management sessions.
          </Typography>
          <Button
            variant="outlined"
            component="a"
